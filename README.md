...
- **배포**: Docker Compose(앱 + Caddy 리버스 프록시/자동 HTTPS), GitHub Actions CI/CD, Oracle Cloud VM
...
# → http://localhost (Caddy 경유)
```

서버 배포(Oracle Cloud VM + GitHub Actions 자동 배포)는 [docs/DEPLOY.md](docs/DEPLOY.md)를 참고하세요.
...
- [ ] 배포 — Docker·CI/CD 구성 완료, VM 셋업 진행 중 ([docs/DEPLOY.md](docs/DEPLOY.md))
- [ ] 예측 게임 채점·리더보드
